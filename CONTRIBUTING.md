...
1. Review the [existing issues](https://github.com/playfulsparkle/oc3_admin_language/issues) to avoid duplicates, or open a ticket on the [support page](https://support.playfulsparkle.com/).
...
- [GitHub Issues](https://github.com/playfulsparkle/oc3_admin_language/issues)
