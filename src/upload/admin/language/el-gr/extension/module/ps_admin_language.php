<?php
// Heading
$_['heading_title']            = 'Playful Sparkle - Γλώσσα Διαχείρισης';
$_['heading_contact']          = 'Επικοινωνία με την Υποστήριξη';

// Text
$_['text_extension']           = 'Επεκτάσεις';
$_['text_success']             = 'Επιτυχία: Έχετε τροποποιήσει τη μονάδα Γλώσσα Διαχείρισης!';
$_['text_edit']                = 'Επεξεργασία μονάδας Γλώσσα Διαχείρισης';
...
// Error
$_['error_permission']         = 'Προειδοποίηση: Δεν έχετε άδεια να τροποποιήσετε τη μονάδα Γλώσσα Διαχείρισης!';
